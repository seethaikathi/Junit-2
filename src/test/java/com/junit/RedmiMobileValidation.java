...
public class RedmiMobileValidation {
	...
	@Test
	public void method3() {
		WebElement mobilesearch = driver.findElement(By.xpath("(//div[contains(text(),'REDMI ')])[1]"));
	...
	@Test
	public void method5() {
		WebElement mobilename = driver.findElement(By.xpath("(//span[contains(text(),'REDMI ')])"));
